...
// parseFreeTextVerdict is a fallback for models/gateways that ignore the
// structured output format and return free-text "AD: <reason>" / "NORMAL".
func parseFreeTextVerdict(raw string) Result {
